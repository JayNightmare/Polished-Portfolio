            ...
            <Card className="bg-gradient-to-br from-muted/50 to-muted/30 border-0 shadow-lg backdrop-blur-sm">
              <CardContent className="p-8 text-center">
                ...
                <p className="text-muted-foreground leading-relaxed max-w-3xl mx-auto">
                  The tech industry moves fast, and I'm committed to continuous learning. 
                  Currently exploring: <strong>AI/ML integration</strong>, <strong>WebAssembly</strong>, and <strong>serverless architectures</strong>. 
                  I believe in staying curious and adapting to new challenges.
                </p>
